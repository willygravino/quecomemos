...
# Estado de selección de platos para lista de compras
@admin.register(ProfilePlatoCompra)
class ProfilePlatoCompraAdmin(admin.ModelAdmin):
    list_display = ("perfil", "plato", "elegido")
    list_filter = ("elegido",)
    search_fields = (
