...
from AdminVideos.views import CrearLugar, EnviarMensaje, LugarDetail, LugarUpdate, PlatoVariedadCreate, PlatoVariedadDelete, PlatoVariedadUpdate,  agregar_a_mi_lista, agregar_plato_compartido, amigue_borrar, amigues, api_ingredientes, api_toggle_item, compartir_elemento, compartir_ing_plato, descartar_sugerido, eliminar_habito, eliminar_lugar, eliminar_plato, eliminar_plato_programado, fijar_plato, historial, index, PlatoUpdate, PlatoCreate, Login, SignUp, ProfileCreate, ProfileUpdate, about, lista_de_compras, FiltroDePlatos, plato_ingredientes, plato_opciones_asignar, random_dia, set_dia_activo, sumar_amigue, toggle_habito_semanal, user_logout, SolicitarAmistad, MensajeDelete, AsignarPlato, compartir_lista
...
urlpatterns = [
    ...
    # path("habito/toggle/<int:plato_id>/<int:dia_semana>/<str:momento>/",toggle_habito_semanal,name="toggle-habito"),
    path('eliminar-habito/<int:plato_id>/<str:comida>/', eliminar_habito, name='eliminar-habito'),
